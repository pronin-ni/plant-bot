...
@Table(
    ...
    indexes = {
        ...
        @Index(name = "idx_plants_user_category", columnList = "user_id, category"),
        @Index(name = "idx_plants_user_name", columnList = "user_id, name"),
        @Index(name = "idx_plants_last_watered", columnList = "last_watered_date"),
